  ...
  <div class="container">
    <div class="footer-top-inner">
      <div class="footer-logo">
        <a href="index.php"><img src="assets/imgs/home-page/logo/sevitsil-logo.webp?ver=<?php echo time(); ?>" alt="site-logo"></a>
      </div>
      <div class="info-text">
  ...
  <div class="copyright-area">
    <div class="copyright-area-inner">
      <div class="copyright-text">
        <p class="text">&copy; Copyright <?php echo date('Y') ?> <a href="index.php">SEVITSIL®</a> All right
          reserved</p>
      </div>
    </div>
  </div>
...
<script src="assets/js/js.js?ver=<?php echo time(); ?>"></script>
